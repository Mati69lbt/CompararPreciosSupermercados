            ...
            <div className="flex flex-col gap-1.5 min-w-0 lg:flex-row lg:items-center lg:gap-3 lg:flex-1">
              <div className="flex gap-1.5 min-w-0 lg:flex-1">
                <input
                  ...
                  className="flex-1 min-w-0 bg-slate-800 border border-slate-700 text-slate-100 text-xs md:text-sm rounded-lg px-3 md:px-4 h-9 focus:ring-2 focus:ring-emerald-500 focus:outline-none"
                />
                <button
                  onClick={dispararBusqueda}
                  className="shrink-0 bg-emerald-600 hover:bg-emerald-500 text-white font-semibold text-xs md:text-sm px-3 md:px-5 h-9 rounded-lg transition-colors"
                >
                  Buscar
                </button>
              </div>
